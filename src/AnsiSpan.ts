//https://github.com/mmalecki/ansispan/blob/master/lib/ansispan.js
module Haxor
{
	export class AnsiSpan
	{
	//https://en.wikipedia.org/wiki/ANSI_escape_code#Colors
	codeto: Object = {
	"39":"gray", //default color
	"0":"gray", //default everything, but only color is supported
	"30":"black",
	"31":"red",
	"32":"green",
	"33":"yellow",
  ...
  {
      str = str.replace(new RegExp('\033\\[' + ansi + 'm', 'g'), span).replace(new RegExp('\033\\[0;' + ansi + 'm', 'g'), span););
  });
	}
}
